            ...
            <div class="row">
                <div class="col">
                    <div class="ms-2 me-2 mt-5 ">
                        <h1>Booking installment Table</h1>
                                ...
                                <tbody>
                                    ...
                                    @if ($data != null)
                                        ...
                                        @foreach ($data as $sale_installement)
                                            ...
                                            <tr>
                                                <td class=" get_sale_lease_id" style="display:none;">{{$sale_installement->sale_lease_id}}</td>
                                                <?php $date = explode(' ', $sale_installement->due_date); ?>
                                                <td class="montly_id">{{ $sale_installement->monthly }}</td>
                                                <td>
                                                    <input type="date" value="{{ date($date[0]) }}">
                                                </td>
                                                <td class="payment" >{{ $sale_installement->payment }}</td>
                                                ...
                                                @if ($sale_installement->status == 0)
                                                <td><button type="button" class="btn btn-primary payment_btn" data-toggle="modal"
                                                        data-target="#exampleModalLong" id="payment" >
                                                        Add Payment
                                                    </button></td>
                                                    @else
...
<!-- Modal -->
<form action="{{ url('payments/sale/store')}}"  method="POST" >
    @csrf
    <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <input type="hidden" name="sale_lease_id" value="">
                <input type="hidden" name="sale_monthly_id" value="">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" class="form-control" value=""  name="payment">
                </div>
                <div class="modal-body">
