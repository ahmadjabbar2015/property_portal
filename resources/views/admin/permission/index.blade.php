            ...
            <div class="row">
                <div class="col">
                    <div class="ms-2 me-2 mt-5 ">
                        ...
                        <button type="button"  class="btn btn-danger mt-5 ml-3 mb-3"  data-toggle="modal" data-target="#exampleModalCenter"> Add Permission
                            </button>
...
@section('page-script')
    ...
    @endsection
<form method="POST" action="{{ url('permission/store') }}" id="">
    @csrf
